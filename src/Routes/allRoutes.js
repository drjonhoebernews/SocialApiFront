...
import YoutubeList from "../pages/Youtube";
import GoogleList from "../pages/Google";

const authProtectedRoutes = [

  { path: "/apps-twitter", component: <TaskList /> },

  { path: "/apps-youtube", component: <YoutubeList /> },

  { path: "/apps-google", component: <GoogleList /> },
