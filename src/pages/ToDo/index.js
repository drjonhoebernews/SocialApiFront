                    ...
                    <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                        <div className="file-manager-sidebar">
                            <div className="p-4 d-flex flex-column h-100">
                                <div className="mb-3">
                                    <button className="btn btn-info w-100" onClick={() => setModalProject(true)}><i className="ri-add-line align-bottom"></i> Kelime Ekle</button>
                                </div>
                        ...
                        <div className="file-manager-content w-100 p-4 pb-0">
                            <Row className="mb-4">
                                ...
                                <div className="col-sm order-3 order-sm-2 mt-3 mt-sm-0">
                                    <h5 className="fw-semibold mb-0">Twitter Tüm Veriler</h5>
                                </div>
                                ...
                                <Row className="g-2">
                                    <Col className="col-lg-auto">
                                        <select className="form-control" name="choices-select-sortlist" id="choices-select-sortlist" onChange={(e) => taskSort(e.target.value)}>
                                            ...
                                            <option value="By Name">AD</option>
                                        </select>
                                    </Col>
                                    <Col className="col-lg-auto">
                                        <select className="form-control" name="choices-select-status" id="choices-select-status" onChange={(e) => taskStatus(e.target.value)}>
                                            ...
                                            <option value="Completed">Kelimelere Göre</option>
                                        </select>
                                    </Col>
                                    <Col className="col-lg">
                                        <div className="search-box">
                                            <input type="text" id="searchTaskList" className="form-control search" placeholder="Arayacağınız kelimeyi girin" onKeyUp={(e) => searchList(e.target.value)} />
                                            <i className="ri-search-line search-icon"></i>
                                        </div>
                                    </Col>
                                    <Col className="col-lg-auto">
                                        <button className="btn btn-primary createTask" type="button" onClick={() => handleTodoClicks()}>
                                            <i className="ri-add-fill align-bottom" /> Yeni Kelime Ekle
                                        </button>
                                    </Col>
                                </Row>
                            </div>
                            ...
                            <div className="todo-content position-relative px-4 mx-n4" id="todo-content">
                                ...
                                <div className="py-4 mt-4 text-center" id="noresult" style={{ display: "none" }}>
                                    ...
                                    <h5 className="mt-4">Herhangi bir kayıt yok!</h5>
                                </div>
                            </div>
                        </div>
                    </div>
