...
const BasicSignIn = () => {
document.title="Basit Giriş Yap | Medyaizi Yönetim Paneli";
    return (
        <React.Fragment>
            <ParticlesAuth>
                    ...
                    <Container>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                <Card className="mt-4">
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Medyaizi'ye Hemen Giriş Yap.</p>
                                        </div>
                                        <div className="p-2 mt-4">
                                            <form action="#">
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <Input type="text" className="form-control" id="username" placeholder="Kullanıcı Adını Giriniz" required/>
                                                </div>

                                                <div className="mb-3">
                                                    <div className="float-end">
                                                        <Link to="/auth-pass-reset-basic" className="text-muted">Parolamı Unuttum ?</Link>
                                                    </div>
                                                    <Label className="form-label" htmlFor="password-input">Parola</Label>
                                                    <div className="position-relative auth-pass-inputgroup mb-3">
                                                        <Input type="password" className="form-control pe-5 password-input" placeholder="Parola Giriniz" id="password-input" required/>
                                                ...
                                                <div className="mt-4">
                                                    <Button color="success" className="btn btn-success w-100" type="submit">Giriş Yap</Button>
                                                </div>
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">Bir Hesabınız Yok mu ? <Link to="/auth-signup-basic" className="fw-semibold text-primary text-decoration-underline"> Şimdi Kayıt Olun. </Link> </p>
                                </div>
