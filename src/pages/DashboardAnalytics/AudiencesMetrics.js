            ...
            <Col xl={6}>
                <Card>
                    <CardHeader className="border-0 align-items-center d-flex">
                        <h4 className="card-title mb-0 flex-grow-1">Metrik Analiz Tablosu</h4>
                        ...
                        <Row className="g-0 text-center">
                            <Col xs={6} sm={4}>
                                <div className="p-3 border border-dashed border-start-0">
                                    ...
                                    <p className="text-muted mb-0">Ortalama Geri Dönüş</p>
                                </div>
                            </Col>
                            <Col xs={6} sm={4}>
                                <div className="p-3 border border-dashed border-start-0">
                            ...
                            <Col xs={6} sm={4}>
                                <div className="p-3 border border-dashed border-start-0 border-end-0">
                                    ...
                                    <p className="text-muted mb-0">Ortalama Oturum Süresi</p>
                                </div>
                            </Col>
                        </Row>
                    </CardHeader>
