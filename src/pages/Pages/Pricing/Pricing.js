...
import {api, title, currency} from "../../../config";
                    ...
                    <Row className="justify-content-center mt-4">
                        <Col lg={5}>
                            <div className="text-center mb-4">
                                <h4 className="fw-semibold fs-22">Bir Plan Seçiniz.</h4>
                                <p className="text-muted mb-4 fs-15">Firmanız Yada Kendiniz İçin Bir Plan Seçimi Yapınız.</p>
                                    ...
                                    <Nav className="nav-pills arrow-navtabs plan-nav rounded mb-3 p-1" id="pills-tab" role="tablist">
                                        ...
                                        <NavItem>
                                            <NavLink
                                                ...
                                                onClick={() => { toggleTab('2'); }}
                                            >Yıllık <span className="badge bg-success">25%</span>
                                            </NavLink>
                                        </NavItem>
                                    </Nav>
                                </div>
                                        ...
                                        <div className="d-flex align-items-center mb-3">
                                            ...
                                            <div className="ms-auto">
                                                <TabContent activeTab={activeTab}>
                                                    <TabPane tabId="1">
                                                        <h2 className="month mb-0">{price1.rate} {currency.symbol}<small className="fs-13 text-muted">/Aylık</small></h2>
                                                    </TabPane>
                                                    <TabPane tabId="2">
                                                        <h2 className="annual mb-0"><small className="fs-16"><del>{price1.delrateYear} {currency.symbol}</del></small> {price1.rateYear} {currency.symbol}<small className="fs-13 text-muted">/Yıllık</small></h2>
                                                    </TabPane>
                                                </TabContent>
                                            </div>
                                        </div>
