...
const Plans = () => {
    ...
    return (
        <React.Fragment>
            <section className="section bg-light" id="paketler">
                <div className="bg-overlay bg-overlay-pattern"></div>
                <Container>
                    <Row className="justify-content-center">
                        <Col lg={8}>
                            <div className="text-center mb-5">
                                <h3 className="mb-3 fw-semibold">Firmanız İçin Bir Plan Seçin</h3>
                                <p className="text-muted mb-4">Medyaizi Veri Analizi Aylık ve Yıllık İndirimli Fiyatlar</p>
                                ...
                                <div className="d-flex justify-content-center align-items-center">
                                    ...
                                    <div>
                                        <h5 className="fs-14 mb-0">Yıllık <span className="badge badge-soft-success">İndirim 20%</span></h5>
                                    </div>
                                </div>
                            </div>
                        </Col>
                            ...
                            <Card className="plan-box mb-0">
                                <CardBody className="p-4 m-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-4">
                                            <Link to="#" className="btn btn-soft-success w-100">Satın Al</Link>
                                        </div>
                                    </div>
                                </CardBody>
                            </Card>
