...
const Features = () => {
    return (
        <React.Fragment>
            ...
            <section className="section bg-light py-5" id="anlik-haber">
                <Container>
                    <Row className="align-items-center gy-4">
                        ...
                        <Col lg={6}>
                            <div className="text-muted">
                                ...
                                <h3 className="mb-3 fs-20">Anlık Canlı Haber Verisi</h3>
                                <p className="mb-4 ff-secondary fs-16">Haber ve son dakika haberleri, güncel haberler, magazin, spor ve ekonomi gündemi,medyaizi.com..</p>
