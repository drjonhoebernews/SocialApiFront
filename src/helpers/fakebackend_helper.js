...
import {GET_YOUTUBE_LIST} from "../store/youtube/actionType";
...
// youtube
// get youtube
export const getYoutubeList = () => api.get(url.GET_YOUTUBE_LIST);


// Google
// get Google
export const getGoogleList = () => api.get(url.GET_GOOGLE_LIST);
