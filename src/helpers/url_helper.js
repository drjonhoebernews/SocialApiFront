...
//LOGIN
export const POST_FAKE_LOGIN = "/account/login";
export const POST_FAKE_JWT_LOGIN = "/account/token";
...
// Task  twitter
export const GET_TASK_LIST = "/twitter/apps/task";
...
// youtube
export const GET_YOUTUBE_LIST = "/youtube/search";

// Google
export const GET_GOOGLE_LIST = "/googlee/googlesearch";
